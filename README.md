...
* [coder/code-server](https://github.com/coder/code-server) ⭐ 79,195 | 🐛 167 | 🌐 TypeScript | 📅 2026-09-04 - Run VS Code in a browser tab. The default web IDE for many Coder workspaces.
* [coder/coder](https://github.com/coder/coder) ⭐ 14,375 | 🐛 991 | 🌐 Go | 📅 2026-09-05 - The Coder server, agent, and CLI. Self-hosted cloud development environments and AI coding agents defined in Terraform.
* [coder/mux](https://github.com/coder/mux) ⭐ 2,003 | 🐛 247 | 🌐 TypeScript | 📅 2026-09-05 - Desktop and browser app for running multiple AI coding agents side-by-side on local or remote compute, with isolated workspaces and a multi-model loop.
...
* [coder/registry](https://github.com/coder/registry) ⭐ 78 | 🐛 69 | 🌐 HCL | 📅 2026-09-04 - Source for the templates and modules published to registry.coder.com.
...
* [coder/vscode-coder](https://github.com/coder/vscode-coder) ⭐ 129 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-04 - VS Code extension to open any Coder workspace with a single click. Also works in VS Code forks like Cursor, Windsurf, and Kiro.
...
* [coder/coder-desktop-macos](https://github.com/coder/coder-desktop-macos) ⭐ 29 | 🐛 22 | 🌐 Swift | 📅 2026-09-04 - Native macOS Coder Desktop client.
...
* [Provision Coder with Lima](https://github.com/coder/coder/tree/main/examples/lima) ⭐ 14,375 | 🐛 991 | 🌐 Go | 📅 2026-09-05 - Linux virtual machines, typically on macOS, for running containerd.
