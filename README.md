...
* [coder/code-server](https://github.com/coder/code-server) ⭐ 79,035 | 🐛 151 | 🌐 TypeScript | 📅 2026-08-20 - Run VS Code in a browser tab. The default web IDE for many Coder workspaces.
* [coder/coder](https://github.com/coder/coder) ⭐ 14,235 | 🐛 969 | 🌐 Go | 📅 2026-08-24 - The Coder server, agent, and CLI. Self-hosted cloud development environments and AI coding agents defined in Terraform.
* [coder/mux](https://github.com/coder/mux) ⭐ 1,981 | 🐛 229 | 🌐 TypeScript | 📅 2026-08-24 - Desktop and browser app for running multiple AI coding agents side-by-side on local or remote compute, with isolated workspaces and a multi-model loop.
* [coder/boo](https://github.com/coder/boo) ⭐ 768 | 🐛 7 | 🌐 Zig | 📅 2026-07-05 - GNU screen-style terminal multiplexer built on libghostty, with `send`, `peek`, and `wait` primitives for driving interactive programs from scripts and AI agents.
* [coder/envbuilder](https://github.com/coder/envbuilder) ⭐ 300 | 🐛 84 | 🌐 Go | 📅 2026-05-22 - Build workspaces from a Dockerfile or devcontainer.json on Docker, Kubernetes, and OpenShift.
* [coder/registry](https://github.com/coder/registry) ⭐ 76 | 🐛 66 | 🌐 HCL | 📅 2026-08-24 - Source for the templates and modules published to registry.coder.com.
...
* [uwu/basic-env](https://github.com/uwu/basic-env) ⭐ 18 | 🐛 2 | 🌐 HCL | 📅 2024-09-22 - Docker-based dev environment with VS Code, an XFCE + noVNC desktop, dotfiles, and preinstalled language runtimes (Dart, Java, JavaScript/Node).
...
* [coder/terraform-provider-coder](https://github.com/coder/terraform-provider-coder) ⭐ 60 | 🐛 47 | 🌐 Go | 📅 2026-08-21 - Template-side Terraform resources: `coder_agent`, `coder_app`, `coder_parameter`, and friends.
* [coder/terraform-provider-coderd](https://github.com/coder/terraform-provider-coderd) ⭐ 29 | 🐛 27 | 🌐 Go | 📅 2026-08-21 - Manage a Coder deployment itself (templates, groups, organizations) with Terraform.

## IDE Integrations

* [coder/vscode-coder](https://github.com/coder/vscode-coder) ⭐ 129 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-21 - VS Code extension to open any Coder workspace with a single click. Also works in VS Code forks like Cursor, Windsurf, and Kiro.
* [coder/coder-jetbrains-toolbox](https://github.com/coder/coder-jetbrains-toolbox) ⭐ 24 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-19 - JetBrains Toolbox plugin for Coder.
...
* [coder/coder-desktop-windows](https://github.com/coder/coder-desktop-windows) ⭐ 26 | 🐛 33 | 🌐 C# | 📅 2026-07-28 - Native Windows Coder Desktop client.
...
* [Provision Coder with Lima](https://github.com/coder/coder/tree/main/examples/lima) ⭐ 14,235 | 🐛 969 | 🌐 Go | 📅 2026-08-24 - Linux virtual machines, typically on macOS, for running containerd.
