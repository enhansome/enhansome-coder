...
* [coder/code-server](https://github.com/coder/code-server) ⭐ 79,005 | 🐛 150 | 🌐 TypeScript | 📅 2026-08-20 - Run VS Code in a browser tab. The default web IDE for many Coder workspaces.
* [coder/coder](https://github.com/coder/coder) ⭐ 14,223 | 🐛 963 | 🌐 Go | 📅 2026-08-22 - The Coder server, agent, and CLI. Self-hosted cloud development environments and AI coding agents defined in Terraform.
* [coder/mux](https://github.com/coder/mux) ⭐ 1,978 | 🐛 233 | 🌐 TypeScript | 📅 2026-08-22 - Desktop and browser app for running multiple AI coding agents side-by-side on local or remote compute, with isolated workspaces and a multi-model loop.
* [coder/boo](https://github.com/coder/boo) ⭐ 767 | 🐛 7 | 🌐 Zig | 📅 2026-07-05 - GNU screen-style terminal multiplexer built on libghostty, with `send`, `peek`, and `wait` primitives for driving interactive programs from scripts and AI agents.
...
* [coder/registry](https://github.com/coder/registry) ⭐ 76 | 🐛 66 | 🌐 HCL | 📅 2026-08-21 - Source for the templates and modules published to registry.coder.com.
...
* [Provision Coder with Lima](https://github.com/coder/coder/tree/main/examples/lima) ⭐ 14,223 | 🐛 963 | 🌐 Go | 📅 2026-08-22 - Linux virtual machines, typically on macOS, for running containerd.
