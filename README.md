...
* [coder/code-server](https://github.com/coder/code-server) ⭐ 78,962 | 🐛 153 | 🌐 TypeScript | 📅 2026-08-19 - Run VS Code in a browser tab. The default web IDE for many Coder workspaces.
* [coder/coder](https://github.com/coder/coder) ⭐ 14,206 | 🐛 983 | 🌐 Go | 📅 2026-08-20 - The Coder server, agent, and CLI. Self-hosted cloud development environments and AI coding agents defined in Terraform.
* [coder/mux](https://github.com/coder/mux) ⭐ 1,977 | 🐛 277 | 🌐 TypeScript | 📅 2026-08-20 - Desktop and browser app for running multiple AI coding agents side-by-side on local or remote compute, with isolated workspaces and a multi-model loop.
* [coder/boo](https://github.com/coder/boo) ⭐ 763 | 🐛 7 | 🌐 Zig | 📅 2026-07-05 - GNU screen-style terminal multiplexer built on libghostty, with `send`, `peek`, and `wait` primitives for driving interactive programs from scripts and AI agents.
...
* [coder/registry](https://github.com/coder/registry) ⭐ 75 | 🐛 71 | 🌐 HCL | 📅 2026-08-19 - Source for the templates and modules published to registry.coder.com.
...
* [coder/terraform-provider-coder](https://github.com/coder/terraform-provider-coder) ⭐ 60 | 🐛 47 | 🌐 Go | 📅 2026-08-20 - Template-side Terraform resources: `coder_agent`, `coder_app`, `coder_parameter`, and friends.
* [coder/terraform-provider-coderd](https://github.com/coder/terraform-provider-coderd) ⭐ 29 | 🐛 33 | 🌐 Go | 📅 2026-08-19 - Manage a Coder deployment itself (templates, groups, organizations) with Terraform.

## IDE Integrations

* [coder/vscode-coder](https://github.com/coder/vscode-coder) ⭐ 129 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-20 - VS Code extension to open any Coder workspace with a single click. Also works in VS Code forks like Cursor, Windsurf, and Kiro.
...
* [Provision Coder with Lima](https://github.com/coder/coder/tree/main/examples/lima) ⭐ 14,206 | 🐛 983 | 🌐 Go | 📅 2026-08-20 - Linux virtual machines, typically on macOS, for running containerd.
